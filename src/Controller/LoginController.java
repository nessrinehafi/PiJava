...
public class LoginController implements Initializable {
    ...
    private void SignUpAction(ActionEvent event) throws IOException {
        Parent list_page_parent = FXMLLoader.load(getClass().getResource("/View/Register.fxml"));
			...
			if (!username.getText().equals("") || !password.getText().equals("")) 
			{
				//if ((su.IsActif(username.getText(), password.getText())) ) 
					...
					{	//si le prestataire can login
						...
						if (su.IsModerateur(LoggedUser.getUsername(), LoggedUser.getPassword())) {	//si lutilisateur est un admin
							Parent list_page_parent = FXMLLoader.load(getClass().getResource("/View/InterfaceModerateur.fxml"));
							Scene list_page_scene = new Scene(list_page_parent);
							Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
