...
public class AccueilInterfaceController implements Initializable {
    ...
    private void deco(ActionEvent event) throws IOException {
        ...
        Parent page_select_my = FXMLLoader.load(getClass().getResource("/sprintjavagui.User/Login.fxml"));        
        Scene scene = new Scene(page_select_my);
        Stage app=(Stage)((Node)event.getSource() ).getScene().getWindow();
        app.setScene(scene);
        app.show();
    ...
    @FXML
    private void rdvattnteuser(ActionEvent event) throws IOException {
   ...
   // page.setStyle("fx-background-image : url("images/progress.jpg")");

    @FXML
    private void Accueil(ActionEvent event) throws IOException {
        
        Parent page_select_my = FXMLLoader.load(getClass().getResource("AccueilGroupe.fxml"));        
        Scene scene = new Scene(page_select_my);
        Stage app=(Stage)((Node)event.getSource() ).getScene().getWindow();
        app.setScene(scene);
        app.show();
