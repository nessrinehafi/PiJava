 ...
 * @author haythem
 */
public class ListerdvattnteuserInterfaceController implements Initializable {
    ...
    @FXML
    private TableColumn<Rendez_vous, String> personne;
    @FXML
    private TableColumn<Rendez_vous, String> adresse;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        {
            if (r.isValide() == false && r.getDemandeur_id() == LoggedUser.getId() && r.isRemove() == false)
            {
                list.add(r);
            }
