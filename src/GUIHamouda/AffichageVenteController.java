 ...
 * @author hamouda
 */
public class AffichageVenteController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ArrayList A = (ArrayList) as.afficheallV("Vente");
    ...
    private void Acheter(ActionEvent event) throws IOException {
        JeAcheterController.annonce_id= table.getSelectionModel().getSelectedItem().getId();
        JeAcheterController.animal= table.getSelectionModel().getSelectedItem().getAnimal();
          Parent page_select_my = FXMLLoader.load(getClass().getResource("/GUIHamouda/JeAcheter.fxml"));        
        Scene scene = new Scene(page_select_my);
        Stage app=(Stage)((Node)event.getSource() ).getScene().getWindow();
        app.setScene(scene);
        app.show();
