 ...
 * @author hamouda
 */
public class JeAdopterController implements Initializable {
    ...
    private void Ajout(ActionEvent event) {
        ...
        Demande d = new Demande(LoggedUser.getId(), annonce_id,"Adoption",
              
        2,t1.getText(),t2.getText(),t3.getText(),"hamouda",t4.getText() ,animal);
        ...
        ds.Ajouter(d);
         Alert al=new Alert(Alert.AlertType.INFORMATION);
            ...
            al.setContentText("demande d'adoption envoyée");
            al.showAndWait();
