 ...
 * @author mehdi
 */
public class TraiterReclamationAdminController implements Initializable {
    ...
    private void listeButtonAction(ActionEvent event) throws IOException {
        ...
        Parent home_page_parent = FXMLLoader.load(getClass().getResource("ReclamationAdmin.fxml"));
        Scene home_page_scene = new Scene(home_page_parent);
        Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        app_stage.setScene(home_page_scene);
        app_stage.show();
    ...
    public void initWindow (){
        utilisateurTF.setText(reclamation.getUser().getNom());
    }

    @Override
    public void initialize(URL url, ResourceBundle rb) {
        //System.out.println(reclamation.getTitre());
    }
