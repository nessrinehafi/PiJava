 ...
 * @author nouha
 */
public class AffichageRechercheController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            ObservableList<Service> ls = rs.RechercheService(recherché);
            ...
            Logger.getLogger(AffichageRechercheController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public AnchorPane createPage(int pageIndex) {
        ...
        ServiceServices rs = new ServiceServices();
        ObservableList<Service> list = rs.RechercheService(recherché);
        ...
        for (int i = page; i < page + itemsPerPage(); i++) {
            if (i <= list.size() - 1) {
                ...
                try {
                    ...
                    Logger.getLogger(ListeEdController.class.getName()).log(Level.SEVERE, null, ex);
                }
