 ...
 * @author nouha
 */
public class MesservicesfavController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            ObservableList<Service> ls = rs.meservicesfavs();
    ...
    public AnchorPane createPage(int pageIndex) {
        ...
        ServiceServices rs = new ServiceServices();
        ObservableList<Service> list = rs.meservicesfavs();
        ...
        for (int i = page; i < page + itemsPerPage(); i++) {
            if (i <= list.size() - 1) {
                ...
                infos = new VBox(2, titre, adresse, user, dateR, b);
